...
def build_parser() -> argparse.ArgumentParser:
    ...
    workbook.add_argument("--file", required=True, help="Path to the XLSX job-posting workbook")
    workbook.add_argument("--row", required=True, type=int, help="Excel row number (header is row 1)")
    workbook.add_argument("--resume", required=True)
    workbook.add_argument("--profile", default="", help="Optional JSON contact profile")
